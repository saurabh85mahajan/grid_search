...
return new class extends Migration
{
    ...
    {
        Schema::create('ccs_3', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('tp_start_date')->nullable();
            $table->date('tp_end_date')->nullable();
            ...
            $table->string('last_ncb')->nullable();
            // $table->integer('rto_id')->nullable();

            // Premium details
            $table->decimal('od', 10, 2)->nullable();
            $table->decimal('rider', 10, 2)->nullable();
            ...
            $table->decimal('paid_per_ca', 10, 2)->nullable();
            $table->decimal('ca_amount', 10, 2)->nullable();
            ...
            $table->decimal('sum_issured', 10, 2)->nullable();
