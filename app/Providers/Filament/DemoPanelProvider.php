...
class DemoPanelProvider extends PanelProvider
{
    public function panel(Panel $panel): Panel
    {
        return $panel
            ...
            ->discoverResources(in: app_path('Filament/Demo/Resources'), for: 'App\\Filament\\Demo\\Resources')
            ->discoverPages(in: app_path('Filament/Demo/Pages'), for: 'App\\Filament\\Demo\\Pages')
            ->pages([
                Dashboard::class,
            ])
            ->discoverWidgets(in: app_path('Filament/Demo/Widgets'), for: 'App\\Filament\\Demo\\Widgets')
            ->widgets([
            ...
            ->middleware([
                ...
                \App\Http\Middleware\EnsureUserIsDemo::class,
            ])
            ->authMiddleware([
                Authenticate::class,
            ]);
